...
export class Backend implements backendInterface {
    ...
    async createNote(arg0: {
        ...
        if (this.processError) {
            try {
                const result = await this.actor.createNote(await to_candid_record_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterNotesByCategory(arg0: Category): Promise<Array<Note>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterNotesByCategory(to_candid_Category_n12(this._uploadFile, this._downloadFile, arg0));
    ...
    async getBookmarks(): Promise<Array<bigint>> {
        if (this.processError) {
            try {
    ...
    async getNote(arg0: bigint): Promise<Note> {
        if (this.processError) {
            try {
                ...
                return from_candid_Note_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getProgress(): Promise<Array<[bigint, bigint]>> {
        if (this.processError) {
            try {
    ...
    async updateProgress(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_variant_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "jee" in value ? Category.jee : "neet" in value ? Category.neet : "class10" in value ? Category.class10 : "class11" in value ? Category.class11 : "class12" in value ? Category.class12 : "iitjee" in value ? Category.iitjee : value;
}
